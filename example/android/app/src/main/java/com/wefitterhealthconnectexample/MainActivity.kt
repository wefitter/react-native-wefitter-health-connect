...
import com.wefitter.healthconnect.service.HealthConnectForegroundService
import com.google.gson.Gson

class NotificationConfig(
  var title: String = "WeFitter for Health Connect",
  var text: String = "Synchronizing Health Connect",
  var iconResourceId: Int = com.wefitter.healthconnect.R.mipmap.ic_notification,
  var channelId: String = "WeFitter for Health Connect",
  var channelName: String = "WeFitter for Health Connect",
)
...
class MainActivity : AppCompatActivity() {
  ...
  fun foregroundServiceRunning(): Boolean {
    ...
    for (service in activityManager.getRunningServices(Int.MAX_VALUE)) {
      val serviceName = "com.wefitter.wefitterhealthconnect.service.HealthConnectForegroundService"
  ...
  fun startFGS() {
    ...
    val fgIntent = Intent(this, HealthConnectForegroundService::class.java)
